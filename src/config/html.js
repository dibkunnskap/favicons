...
module.exports = {
  ...
  opensearch: [
    ({ appName, searchName, relative }) => searchName ? `<link rel="search" type="application/opensearchdescription+xml" href="${relative("opensearch-description.xml")}" title="${searchName}">` : `<link rel="search" type="application/opensearchdescription+xml" href="${relative("opensearch-description.xml")}" title="${appName}">`
  ]
};
